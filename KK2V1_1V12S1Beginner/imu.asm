...
;	rjmp im41 ;debug skip correction
	...
	b16cmp AccZfilter, AccZTest		;skip correction if vertical accelleration is outside 0.5 to 1.5 G
	longbrge im41					; 2g = 128 : 4g = 64 : 8g = 32 : 16g = 16

	b16neg AccZTest
	b16cmp AccZfilter, AccZTest
	longbrlt im41
...
im41:
	b16neg AccZTest	;change back to +ve value for next time in imu.asm
...
im30:
	...
	b16mul GyroRoll, GyroRoll, GyroMult
	b16mul GyroPitch, GyroPitch, GyroMult
	b16mul GyroYaw, GyroYaw, GyroMult
