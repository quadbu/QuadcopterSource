/*
 * KK2V1_1V12S1Beginner.asm
 *
 *  Created: 05/01/2014 11:09:43
 *   Author: Steve
 */ 
...
;--- Variables init ---
	...
	rvsetflagfalse flagSat			; used to check if Spektrum Satellite working 

	// Set to Spectrum Satellite if button 2&3 are pressed

	call GetButtons	
	cpi t, 0x06		;Button 2&3
	brne skipsetsatellite

	rvsetflagtrue flagCppmOn	; flag CppmOn is used for Spectrum Satellite
	ser t
	ldz eeCppmOn
	call WriteEeprom
...
skipsetsatellite:
	...
	rvbrflagfalse flagCppmOn, skipusartsetup
	call UsartInit
