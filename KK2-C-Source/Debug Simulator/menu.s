...
.Ldebug_macro0:
	...
	.long	.Ldebug_macro28
	.byte	0x4
	.file 36 "c:\\program files\\atmel\\atmel toolchain\\avr8 gcc\\native\\3.4.1061\\avr8-gnu-toolchain\\avr\\include\\string.h"
	.byte	0x3
	.uleb128 0x16
	.uleb128 0x24
	.byte	0x7
...
.LASF2155:
	.string	"KEYPRESS (keys & (KEY_1|KEY_2|KEY_3|KEY_4))"
.LASF463:
...
.LASF2148:
	.string	"KEYREFRESH (keys & KEY_REFRESH)"
.LASF906:
	.string	"ACIC 2"
.LASF2474:
...
.LASF2156:
	.string	"NOKEYRETURN {if (!keys) return;}"
.LASF1736:
