...
.LASF327:
	.string	"AVR 1"
.LASF2010:
	.string	"_digDev(a,state,toggle) if (a.interval) { if (m >= a.end) { toggle; a.end = m + a.interval; } } else if (a.end && state) if (m >= a.end) toggle;"
.LASF570:
