...
.L29:
	...
	ldi r30,lo8(RX_raw)
	ldi r31,hi8(RX_raw)
	ldi r28,lo8(Config+1)
	ldi r29,hi8(Config+1)
	ldi r26,lo8(RX)
	ldi r27,hi8(RX)
.LBE19:
.LBB20:
...
.LVL23:
	.loc 1 191 0
	ldi r21,hi8(RX_raw+16)
	cpi r30,lo8(RX_raw+16)
	cpc r31,r21
	brne .L28
.LBE20:
	.loc 1 215 0
